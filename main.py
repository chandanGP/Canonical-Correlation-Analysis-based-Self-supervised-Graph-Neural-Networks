...
if __name__ == "__main__":
    ...
    model_coa_ph=CCA_homo(model_lst).to(device)
    ...
    train_cca_model(model_coa_ph,loader_train,loader_val,optimizer_coa_ph,loss_cca2,device,100,0.001,0.5,0.5,0.5,0.5,save_path=save_path,name='Coa_ph')
    '''
    ...
    model_lst=[(-1,512),(512,512)]
    model_coa_cs=CCA_homo(model_lst).to(device)
    optimizer_coa_cs=torch.optim.Adam(model_coa_cs.parameters(), lr=0.001, weight_decay=0)
    train_cca_model(model_coa_cs,loader_train,loader_val,optimizer_coa_cs,loss_cca2,device,50,0.001,1.0,0.2,1.0,0.2,save_path=save_path,name='Coa_cs')
    #decoder
    ...
    model_lst=[(-1,512),(512,512)]
    model_azn_com=CCA_homo(model_lst).to(device)
    optimizer_azn_com=torch.optim.Adam(model_azn_com.parameters(), lr=0.001, weight_decay=0)
    train_cca_model(model_azn_com,loader_train,loader_val,optimizer_azn_com,loss_cca2,device,50,0.0005,0.3,0.1,0.3,0.1,save_path=save_path,name='Azn_com')
    #decoder
    ...
    model_lst=[(-1,512),(512,512)]
    model_azn_ph=CCA_homo(model_lst).to(device)
    optimizer_azn_ph=torch.optim.Adam(model_azn_ph.parameters(), lr=0.001, weight_decay=0)
    train_cca_model(model_azn_ph,loader_train,loader_val,optimizer_azn_ph,loss_cca2,device,50,0.001,0.3,0.2,0.3,0.2,save_path=save_path,name='Azn_ph')
    #decoder
    ...
    model_lst=[(-1,512),(512,512)]
    model_cora=CCA_homo(model_lst).to(device)
    optimizer_cora=torch.optim.Adam(model_cora.parameters(), lr=0.001, weight_decay=0)
    train_cca_model(model_cora,loader_train,loader_val,optimizer_cora,loss_cca2,device,50,0.001,0.4,0.1,0.4,0.1,save_path=save_path,name='Cora')
    #decoder
    ...
    model_lst=[(-1,512)]
    model_citeseer=CCA_homo(model_lst).to(device)
    optimizer_citeseer=torch.optim.Adam(model_citeseer.parameters(), lr=0.001, weight_decay=0)
    train_cca_model(model_citeseer,loader_train,loader_val,optimizer_citeseer,loss_cca2,device,20,0.0005,0.5,0.0,0.5,0.0,save_path=save_path,name='Citeseer')
    #decoder
    ...
    model_lst=[(-1,512),(512,512)]
    model_pbmd=CCA_homo(model_lst).to(device)
    optimizer_pbmd=torch.optim.Adam(model_pbmd.parameters(), lr=0.001, weight_decay=0)
    train_cca_model(model_pbmd,loader_train,loader_val,optimizer_pbmd,loss_cca2,device,100,0.001,0.5,0.3,0.5,0.3,save_path=save_path,name='Pubmed')
    #decoder
